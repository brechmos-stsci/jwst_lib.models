...
class NircamPhotomModel(PhotomModel):
    ...
    """
    schema_url = "nircam_photom.schema.json"
...
class NirissPhotomModel(PhotomModel):
    ...
    """
    schema_url = "niriss_photom.schema.json"
...
class NirspecPhotomModel(PhotomModel):
    ...
    """
    schema_url = "nirspec_photom.schema.json"
...
class MiriImgPhotomModel(PhotomModel):
    ...
    """
    schema_url = "mirimg_photom.schema.json"
...
class MiriMrsPhotomModel(PhotomModel):
    ...
    """
    schema_url = "mirmrs_photom.schema.json"
